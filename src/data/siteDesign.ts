...
export const defaultSiteDesign: SiteDesign = {
  ...
  hero: {
    ...
    contentScale: 1,
    elements: {
      branding: { x: 5, y: 9, w: 17, h: 11, fontSize: 1, visible: true, locked: false },
      motto: { x: 5, y: 21, w: 18, h: 8, fontSize: 0.82, visible: true, opacity: 72, textAlign: "left", locked: false },
      owner: { x: 4.4, y: 30, w: 18, h: 53, fontSize: 1, visible: true, radius: 24, locked: false },
      eyebrow: { x: 28, y: 13, w: 41, h: 6, fontSize: 0.9, visible: true, textAlign: "left", locked: false },
      headline: { x: 28, y: 22, w: 47, h: 31, fontSize: 1.08, visible: true, textAlign: "left", locked: false },
      description: { x: 28, y: 58, w: 44, h: 13, fontSize: 1, visible: true, opacity: 85, textAlign: "left", locked: false },
      buttons: { x: 28, y: 73, w: 44, h: 10, fontSize: 1, visible: true, locked: false },
      featured: { x: 76, y: 13, w: 20, h: 61, fontSize: 1, visible: true, radius: 24, locked: false },
    },
  },
  theme: {
    bg: "0 0% 4%",
  ...
  if (incoming.hero && typeof incoming.hero === "object") {
    ...
    if (hero.elements && typeof hero.elements === "object") {
      for (const key of Object.keys(base.hero.elements) as HeroElementId[]) {
        ...
        if (src.textAlign === "left" || src.textAlign === "center" || src.textAlign === "right") target.textAlign = src.textAlign;
        if (typeof src.locked === "boolean") target.locked = src.locked;
      }
    }
  }
